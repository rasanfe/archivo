...
Change:		Ramón San Félix Ramón  16-11-2022  Adato función para mostrar mensaje simple a usuarios finales. Y mensaje completo a mi.
**********************************************************************************************************************/
string	ls_msg
string	ls_msg_title
string ls_error
...
Change:		Ramón San Félix Ramón  16-11-2022 Guardo la información en mi Tabla de Incidiencias.
**********************************************************************************************************************/
...
String ls_clase, ls_error, ls_script, ls_linea
ls_clase =  this.is_class
ls_error = "Error:" + String(this.ii_err_num) + ": " + this.GetMessage()
ls_script =  "Script: " + this.is_script
ls_linea = "Ln: " + String(this.ii_line)
