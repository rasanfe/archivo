$PBExportHeader$nvo_pdfextractor.sru
forward
global type nvo_pdfextractor from dotnetobject
end type
end forward
...
global nvo_pdfextractor nvo_pdfextractor

type variables

PUBLIC:
String is_assemblypath = "bin\PdfExtractor.dll"
String is_classname = "PdfExtractor.PdfExtractor"
...
public function long of_pdftotxt(string as_inputfile,string as_outputfile,long al_pagefrom,long al_pageto)
public function blob of_pdftoblob(string as_inputfile,long al_pagefrom,long al_pageto)
...
Try
	...
	ll_result = This.pdftotxt(as_inputfile,as_outputfile,al_pagefrom,al_pageto)
	Return ll_result
...
Try
	...
	/* Trigger the dotnet function */
	lbyt_result = This.pdftoblob(as_inputfile,al_pagefrom,al_pageto)
	Return lbyt_result
Catch(runtimeerror re_error)
...
on nvo_pdfextractor.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfextractor.destroy
