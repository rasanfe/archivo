$PBExportHeader$nvo_pdffill.sru
forward
global type nvo_pdffill from dotnetobject
end type
end forward
...
global nvo_pdffill nvo_pdffill

type variables

PUBLIC:
String is_assemblypath = gs_dir+"bin\PdfFillFormFields.dll"
String is_classname = "PdfFillFormFields.PdfFill"
...
public function string of_fillformfields(string as_inputfile,string as_outputfile,string as_fieldnames[],string as_datafield[])
public function string of_getformfields(string as_inputfile,ref string as_fieldnames[])
end prototypes
...
public function string of_fillformfields(string as_inputfile,string as_outputfile,string as_fieldnames[],string as_datafield[]);
//*-----------------------------------------------------------------*/
//*  .NET function : FillFormFields
//*   Argument:
//*              String as_inputfile
//*              String as_outputfile
//*              String as_fieldnames[]
//*              String as_datafield[]
//*   Return : String
//*-----------------------------------------------------------------*/
/* .NET  function name */
...
Try
	...
	ls_result = This.fillformfields(as_inputfile,as_outputfile,as_fieldnames,as_datafield)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.getformfields(as_inputfile,ref as_fieldnames)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_pdffill.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdffill.destroy
