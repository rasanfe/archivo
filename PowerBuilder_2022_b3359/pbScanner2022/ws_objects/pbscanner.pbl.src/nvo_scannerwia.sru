$PBExportHeader$nvo_scannerwia.sru
forward
global type nvo_scannerwia from dotnetobject
end type
end forward
...
global nvo_scannerwia nvo_scannerwia
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.scan(as_scanner,as_format,as_outputpath,as_filename)
	Return ls_result
Catch(runtimeerror re_error)
