$PBExportHeader$nvo_imagefrompdf.sru
forward
global type nvo_imagefrompdf from dotnetobject
end type
end forward
...
global nvo_imagefrompdf nvo_imagefrompdf

type variables

PUBLIC:
String is_assemblypath = gs_dir + "bin\ImageFromPdf.dll"
String is_classname = "ImageFromPdf.ImageFromPdf"
...
public function string of_pdftobmp(string as_source)
public function string of_pdftobmp(string as_source,long al_pagefrom,long al_pageto)
public function string of_pdftopng(string as_source)
public function string of_pdftopng(string as_source,long al_pagefrom,long al_pageto)
...
Try
	...
	ls_result = This.pdftobmp(as_source)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.pdftobmp(as_source,al_pagefrom,al_pageto)
	Return ls_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.pdftopng(as_source)
	Return ls_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.pdftopng(as_source,al_pagefrom,al_pageto)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_imagefrompdf.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_imagefrompdf.destroy
