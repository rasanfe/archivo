$PBExportHeader$nvo_imageocr.sru
forward
global type nvo_imageocr from dotnetobject
end type
end forward
...
global nvo_imageocr nvo_imageocr

type variables

PUBLIC:
String is_assemblypath = gs_dir + "bin\ImageOCR.dll"
String is_classname = "ImageOCR.ImageOCR"
...
public function string of_convertimagetostring(string as_imagepath)
public subroutine  of_convertimagetotxt(string as_imagepath,string as_txtpath)
public function string of_convertimagetostring(string as_imagepath,string as_datapath,string as_language)
public subroutine  of_convertimagetotxt(string as_imagepath,string as_txtpath,string as_datapath,string as_language)
public function string of_savebmpaspng(string as_imagepath)
...
public function string of_convertimagetostring(string as_imagepath);
//*-----------------------------------------------------------------*/
//*  .NET function : ConvertImageToString
//*   Argument:
//*              String as_imagepath
//*   Return : String
//*-----------------------------------------------------------------*/
...
ls_function = "ConvertImageToString"
...
Try
	...
	ls_result = This.convertimagetostring(as_imagepath)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	This.convertimagetotxt(as_imagepath,as_txtpath)
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.convertimagetostring(as_imagepath,as_datapath,as_language)
	Return ls_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.savebmpaspng(as_imagepath)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_imageocr.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_imageocr.destroy
