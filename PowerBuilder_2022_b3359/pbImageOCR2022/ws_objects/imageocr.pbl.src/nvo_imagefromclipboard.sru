$PBExportHeader$nvo_imagefromclipboard.sru
forward
global type nvo_imagefromclipboard from dotnetobject
end type
end forward
...
global nvo_imagefromclipboard nvo_imagefromclipboard

type variables

PUBLIC:
String is_assemblypath = gs_dir + "bin\ImageFromClipboard.dll"
String is_classname = "ImageFromClipboard.ImageFromClipboard"
...
public function string of_getclipboardimage()
...
public function string of_getclipboardimage();
//*-----------------------------------------------------------------*/
//*  .NET function : GetClipboardImage
//*   Return : String
//*-----------------------------------------------------------------*/
/* .NET  function name */
String ls_function
...
Try
	...
	ls_result = This.getclipboardimage()
	Return ls_result
...
on nvo_imagefromclipboard.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_imagefromclipboard.destroy
