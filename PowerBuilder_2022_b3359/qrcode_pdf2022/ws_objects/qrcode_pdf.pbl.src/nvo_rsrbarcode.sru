$PBExportHeader$nvo_rsrbarcode.sru
forward
global type nvo_rsrbarcode from dotnetobject
end type
end forward
...
global nvo_rsrbarcode nvo_rsrbarcode
...
public function string of_readbarcodepdf(string as_inputfile)
public function string of_readbarcode(string as_imagename)
public subroutine  of_barcodegenerate(string as_source,string as_outputfile)
public subroutine  of_qrgenerate(string as_source,string as_outputfile)
public function string of_pdftobmp(string as_source,string as_outputfile,long al_pagefrom,long al_pageto)
end prototypes
...
Try
	...
	ls_result = This.readbarcodepdf(as_inputfile)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.readbarcode(as_imagename)
	Return ls_result
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	This.barcodegenerate(as_source,as_outputfile)
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	This.qrgenerate(as_source,as_outputfile)
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.pdftobmp(as_source,as_outputfile,al_pagefrom,al_pageto)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_rsrbarcode.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_rsrbarcode.destroy
