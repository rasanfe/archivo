$PBExportHeader$nvo_zxingnetcoreclass.sru
forward
global type nvo_zxingnetcoreclass from dotnetobject
end type
end forward
...
global nvo_zxingnetcoreclass nvo_zxingnetcoreclass

type variables

PUBLIC:
String is_assemblypath = "ZxingBarcode.dll"
String is_classname = "ZxingBarcode.ZxingNetCoreClass"
...
public function string of_barcodegenerate(string as_source,string as_outputfile,long al_informat,long al_height,long al_width,boolean abln_purebarcode,long al_margin)
end prototypes
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.barcodegenerate(as_source,as_outputfile,al_informat,al_height,al_width,abln_purebarcode,al_margin)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_zxingnetcoreclass.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_zxingnetcoreclass.destroy
