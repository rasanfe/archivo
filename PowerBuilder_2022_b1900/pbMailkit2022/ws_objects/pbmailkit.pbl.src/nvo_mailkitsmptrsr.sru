...
public subroutine  of_setbccrecipientemail(string as_pbbccrecipientname,string as_pbbccrecipientmail)
public subroutine  of_setreplytoemail(string as_pbreplytoname,string as_pbreplytomail)
public subroutine  of_setsenderemail(string as_pbsendername,string as_pbsendermail)
...
Try
	...
	/* Trigger the dotnet function */
	This.setbccrecipientemail(as_pbbccrecipientname,as_pbbccrecipientmail)
Catch(runtimeerror re_error)
...
Try
	...
	/* Trigger the dotnet function */
	This.setsenderemail(as_pbsendername,as_pbsendermail)
Catch(runtimeerror re_error)
